/*
 * ============================================================================
 * FROM EHBW / Cfx PR #3477 (RDR3 128-player support) - NOT MY (alva) WORK.
 * Integrated onto ihatemylife-128 as the client-side base. My own patches
 * (e.g. the sub_140A9F3B8 32-slot array fix) live in alva_128_patches.cpp.
 * ============================================================================
 */
